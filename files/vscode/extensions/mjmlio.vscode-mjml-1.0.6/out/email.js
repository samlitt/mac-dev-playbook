...
class Email {
    ...
    nodemailer(subject, recipients, html, attachments) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield nodemailer_1.createTransport(transportOptions)
                .sendMail({
                attachments,
                from: {
    ...
    mailjet(subject, recipients, html, attachments) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield node_mailjet_1.connect(vscode_1.workspace.getConfiguration('mjml').mailjetAPIKey, vscode_1.workspace.getConfiguration('mjml').mailjetAPISecret)
                .post('send')
                .request({
